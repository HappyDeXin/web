...
function getPolicyType(){
	...
	for(var i=0 ;i<inform.result.length;i++){ 
	    n=i+1;
	    news_second1.append('<li><a href="file:///C:/Users/wzy/Desktop/zuzu/web/model.html?id=' +n+2+'"'  + '" target="_blank" >' + inform.result[i].Infvalue + '</a></li>'); 
		conten2_ul1.append('<li><a href="file:///C:/Users/wzy/Desktop/zuzu/web/model.html?id=' +n+2+'"'  + '" target="_blank" >' + inform.result[i].Infvalue + '</a></li>');
		conten2_ul2.append('<li><a href="file:///C:/Users/wzy/Desktop/zuzu/web/model.html?id=' +n+2+'"'  + '" target="_blank" >' + inform.result[i].Infvalue + '</a></li>');
